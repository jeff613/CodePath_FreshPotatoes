...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        barAppearance.barTintColor = UIColor.brownColor()
        barAppearance.titleTextAttributes = [NSForegroundColorAttributeName:UIColor.whiteColor()]
        
        var tabAppearance = UITabBar.appearance()
        tabAppearance.tintColor = UIColor.whiteColor()
        tabAppearance.barTintColor = UIColor.brownColor()
